...
ZEPHIR_INIT_CLASS(Snail_Mvc_Application) {
	...
	ZEPHIR_REGISTER_CLASS(Snail\\Mvc, Application, snail, mvc_application, snail_mvc_application_method_entry, 0);

	zend_declare_property_null(snail_mvc_application_ce, SL("router"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_class_implements(snail_mvc_application_ce TSRMLS_CC, 1, snail_mvc_applicationinterface_ce);
	return SUCCESS;
