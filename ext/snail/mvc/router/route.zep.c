...
ZEPHIR_INIT_CLASS(Snail_Mvc_Router_Route) {
	...
	ZEPHIR_REGISTER_CLASS(Snail\\Mvc\\Router, Route, snail, mvc_router_route, snail_mvc_router_route_method_entry, 0);

	zend_declare_property_null(snail_mvc_router_route_ce, SL("id"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(snail_mvc_router_route_ce, SL("path"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(snail_mvc_router_route_ce, SL("methods"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(snail_mvc_router_route_ce, SL("handler"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_long(snail_mvc_router_route_ce, SL("uniqueId"), 1, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	zend_class_implements(snail_mvc_router_route_ce TSRMLS_CC, 1, snail_mvc_router_routeinterface_ce);
	return SUCCESS;
...
PHP_METHOD(Snail_Mvc_Router_Route, __construct) {
	...
	ZEPHIR_OBS_VAR(_0);
	zephir_read_static_property_ce(&_0, snail_mvc_router_route_ce, SL("uniqueId") TSRMLS_CC);
	zephir_update_property_this(this_ptr, SL("id"), _0 TSRMLS_CC);
	zephir_update_property_this(this_ptr, SL("path"), path TSRMLS_CC);
	_1 = zephir_fetch_static_property_ce(snail_mvc_router_route_ce, SL("uniqueId") TSRMLS_CC);
	ZEPHIR_INIT_ZVAL_NREF(_2);
	ZVAL_LONG(_2, (zephir_get_numberval(_1) + 1));
	zephir_update_static_property_ce(snail_mvc_router_route_ce, SL("uniqueId"), &_2 TSRMLS_CC);
...
PHP_METHOD(Snail_Mvc_Router_Route, setHttpMethods) {
	...
	zephir_is_iterable(httpMethods, &_1, &_0, 0, 0, "snail/mvc/router/route.zep", 51);
	for (
